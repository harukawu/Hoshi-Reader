...
public struct DictionaryLookupOverlay: View {
    public enum BackgroundInteraction: Equatable, Sendable {
        case dismiss
        case passthrough
    }
    ...
    private let backgroundInteraction: BackgroundInteraction
    ...
    public init(
        ...
        backgroundInteraction: BackgroundInteraction = .dismiss,
    ...
    public var body: some View {
        GeometryReader { geometry in
            ZStack {
                if !popups.isEmpty, backgroundInteraction == .dismiss {
                    Color.clear
